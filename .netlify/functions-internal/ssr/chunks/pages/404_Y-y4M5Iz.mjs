...
const $$BaseHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { title, description, image = "/images/logo-header-light.svg" } = Astro2.props;
