import { $ as $$BaseHead, S as SITE_TITLE, c as SITE_DESCRIPTION, a as $$Header, b as $$Footer } from './404_Y-y4M5Iz.mjs';
...
import 'kleur/colors';
import { v as ve, $ as $$StoryblokComponent } from './__DQMdo6It.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const content = data.story.content;
  return renderTemplate`<html lang="en"> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": SITE_TITLE, "description": SITE_DESCRIPTION })}${renderHead()}</head> <body class="bg-light-neutral dark:bg-dark-neutral"> ${renderComponent($$result, "Header", $$Header, {})} <div class=" min-h-fit"> ${renderComponent($$result, "StoryblokComponent", $$StoryblokComponent, { "blok": content, "updatedDate": data.story.published_at })}</div> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
